...
@Component({
  selector: 'dhpp-app-veroeffentlichungen-uebersicht',
  templateUrl: './uebersicht.component.html',
  styleUrls: ['uebersicht.component.scss']
})
export class AppVeroeffentlichungenUebersichtComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.sidebarService.entries['left'] = [{ 'title': 'Suche', 'href': '/veroeffentlichungen/suche' }];

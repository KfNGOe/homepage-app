...
import { DhppHealthCheckComponent } from 'app/admin/health/health.component';
import { DhppHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
  describe('DhppHealthCheckComponent', () => {
    let comp: DhppHealthCheckComponent;
    let fixture: ComponentFixture<DhppHealthCheckComponent>;
    let service: DhppHealthService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [DhppbaseTestModule],
        declarations: [DhppHealthCheckComponent]
      })
        .overrideTemplate(DhppHealthCheckComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(DhppHealthCheckComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(DhppHealthService);
    });

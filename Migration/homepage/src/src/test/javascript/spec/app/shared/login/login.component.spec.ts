...
describe('Component Tests', () => {
  describe('LoginComponent', () => {
    let comp: DhppLoginModalComponent;
    let fixture: ComponentFixture<DhppLoginModalComponent>;
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [DhppLoginModalComponent],
        providers: [
          FormBuilder,
          {
        ...
        .overrideTemplate(DhppLoginModalComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(DhppLoginModalComponent);
